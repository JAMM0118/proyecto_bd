...
class DatabaseHelper {
  ...
  Future<void> insertDataClientes(String cedula, String nombre, String telefono) async {
...
Future<void> insertDataMateriaPrima(String codigo,String tipo, String stock, String descripcion,
String medida, String nit, String nombre,String direccion, String telefono , String suministro) async {
    ...
    try {
      await _connection.query(
        ...
        @telefonoproveedor,@materiaprimasuministrada)""",
        substitutionValues: {
          'nitproveedor': nit,
      ...
      throw Exception('Error al insertar datos en la tabla materia prima y proveedor $e');
    }
  }
Future<void> insertDataPedido(String numero,String abono, String fechaEncargo, String fechaEntrega,
String medidas, String estado, String cliente,String cantidad, String producto) async {
    ...
    try {
      await _connection.query(
        """INSERT INTO pedido("numeropedido","abono",
...
Future<List<Map<String,dynamic>>> selectDataStock() async {
  ...
  final results = await _connection.query("""select descripcionproducto,tipoproducto, stockproducto - COALESCE(SUM((pedido.cantidad)),0) 
AS cantidad 
